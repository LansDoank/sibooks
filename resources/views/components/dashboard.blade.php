    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Sibooks</div>
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="{{ request()->is('admin/rack') ? 'active' : '' }} flex justify-center md:justify-start nav-item">
                <a class="nav-link collapsed d-flex" href="/admin/rack" data-target="#collapseTwo" aria-expanded="true"
                    aria-controls="collapseTwo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Sibooks 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    ...
                    <a class="btn btn-danger" href="/user/logout">Keluar</a>
                </div>
            </div>
        </div>
    </div>
