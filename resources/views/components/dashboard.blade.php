...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed d-flex" href="/admin/akun" data-target="#collapseUtilities" aria-expanded="true"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed d-flex" href="/admin/buku" data-target="#collapseTwo" aria-expanded="true"
