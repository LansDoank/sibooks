<x-dashboard :title="$title" :heading="$heading" :user="$user">
    <section class="bg-white dark:bg-gray-900  border shadow rounded">
        <div class="py-4 px-4 mx-auto max-w-6xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Rak</h2>
            <form action="/admin/rack/update" method="post">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Nama Rak</label>
                        <input type="text" name="name" id="name" value="{{ $rack->name }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select id="category" name="category"
                            ...
                            required>
                            <option disabled>Pilih Kategori Rak</option>
